...
### 5. YARA - MALWARE PROTECTION

**Product:** YARA (pattern matching)
**Version:** YARA 4.5.2
**Primary Function:** Rule-based malware detection (FIPS-compatible)
**NIST Controls:** SI-3

#### Purpose

Malware detection using rule-based pattern matching with YARA, integrated with
Wazuh for automated file integrity monitoring and active response. YARA operates
in FIPS 140 mode without compatibility issues.

> **ClamAV Status:** Not installed. ClamAV 1.4.x is incompatible with FIPS 140
> mode (OpenSSL 3 FIPS provider rejects legacy algorithms used during signature
> verification). Deployment is pending a FIPS-compatible release (1.5.x) in EPEL.
> See POA&M-014 and Risk Acceptance Memorandum for details.
...
- ClamAV email scanning integration (pending FIPS-compatible 1.5.x release)
...
**Location:** /var/www/cyberhygiene/System_Security_Technical_Overview.md
